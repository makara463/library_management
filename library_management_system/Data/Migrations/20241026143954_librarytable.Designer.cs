...
namespace library_management_system.Data.Migrations
{
    ...
    [Migration("20241026143954_librarytable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("library_management_system.Models.Branch", b =>
                {
                    b.Property<int>("BranchID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library_management_system.Models.Issue", b =>
                {
            ...
            modelBuilder.Entity("library_management_system.Models.Publication", b =>
                {
                    b.Property<int>("PublicationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("library_management_system.Models.Book", b =>
                {
                    b.HasOne("library_management_system.Models.Branch", "Branch")
                        .WithMany("books")
                        .HasForeignKey("BranchID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("library_management_system.Models.Publication", "Publication")
                        .WithMany("books")
            ...
            modelBuilder.Entity("library_management_system.Models.Student", b =>
                {
                    b.HasOne("library_management_system.Models.Branch", "branches")
                        .WithMany("students")
                        .HasForeignKey("BranchID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
